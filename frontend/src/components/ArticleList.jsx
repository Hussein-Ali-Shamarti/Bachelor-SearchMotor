// Denne komponenten viser en rullbar sidemeny med søkeresultater (artikler) basert på en søkestreng.
// Den henter embedding fra serveren, utfører et AI-basert søk, og viser treffliste. 
// Brukeren kan laste inn flere resultater etter hvert og velge en artikkel for detaljer.
