// Denne komponenten viser detaljer for en valgt artikkel, inkludert tittel, forfattere, metadata, nøkkelord og sammendrag.
// Brukeren kan generere et AI-basert sammendrag eller starte en chat om artikkelen. Nøkkelord og forfatternavn fungerer som klikkbare søketriggere.
...
const ArticleDetails = ({ selectedArticle, onOpenChat, onSearch, clearSelectedArticle, setQueryText }) => {
  ...
  return (
    <section className="dashboard-cards">
      <div className={`selected-article-card full-width ${showSummary ? "" : "full-width"}`}>
            ...
            <>
              ...
              <div className="article-meta-block">
                ...
                <div className="article-location">
                  Conference Location: {selectedArticle.conference_location}
                </div>
                <div className="article-date">
                  Publication Date: {selectedArticle.publication_date}
                </div>
      ...
      {showSummary && (
        <div className="summary-article-card full-width">
          ...
          <div className="card-content">
            <h2>AI Summary</h2>
            {summaryLoading ? <p>Loading summary...</p> : <p>{summary || "No summary available."}</p>}
          </div>
        </div>
      )}
    </section>
